(function (m, ma) {
    ...
    function sb(a, b, e) {
        ...
        function g(w,
                   I) {
            var R, V = la + "-widget-header", ea = la + "-widget-content", aa, LLL;
            // LLL = "";
    ...
    function Qb() {
        function a(i, C) {
            ...
            var n = new Array(0)
            for(P = 0; P < i.length; P++) {//合并数据
                temp = i[P].event
                n.push([[temp['title']],[temp['_id']],[temp['start']],[temp['end']],[temp['allDay']]])
            }
            // var n1 = [...new Set(n)]
            $.ajax({//发送数据
                'url': 'http://127.0.0.1:8000/register/scheduleApi/',
                'type': 'get',
                'data': {data:n},
                'success': function (d) {
                    console.log(d);
        ...
        function e(i) {
            ...
            for (P = 0; P < E; P++) {
                ...
                // 'url': 'http://127.0.0.1:8000/register/scheduleApi/',
                // 'type': 'get',
                // 'data': {title:n.title, start:n.start, end:n.end, allday:n.allDay},
                // 'success': function (d) {
                //     console.log(d);
                //     },
                // 'error': function (d) {
            ...
            //     'url': 'http://127.0.0.1:8000/register/scheduleApi/',
            //     'type': 'get',
            //     'data': {title:n.title, start:n.start, end:n.end, allday:n.allDay, id:n._id},
            //     'success': function (d) {
            //         console.log(d);
            //         },
            //     'error': function (d) {
    ...
    var Ya = {
        ...
        startParam: "start",
        endParam: "end",
        titleFormat: {month: "yyyy年 MMMM", week: "yyyy年 MMM d日{ '&#8212;'[ MMM] d日}", day: "yyyy年 MMM d日 dddd"},
